<%@ page language="java" import="java.util.*,com.jxau.pojo.User" pageEncoding="utf-8"%>
...
<body>
<div id="header" class="wrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-4" data-genuitec-path="${pageContext.request.contextPath }/reg">
